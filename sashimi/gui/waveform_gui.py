...
class WaveformWidget(QWidget):
    ...
    def update_pulses(self):
        ...
        self.pulse_regions = [self._create_hspan((pulse, pulse + self.camera_exposure_s), color_plane)
        ...
        self.pulse_regions.append(self._create_hspan((current_pulse, current_pulse + self.camera_exposure_s),
                                                     color_current_plane))
    ...
    def update(self):
        ...
        if len(self.pulse_times) > 0:
            current_pulse = self.pulse_times[self.state.current_plane]
            self.pulse_regions[-1].setRegion((current_pulse, current_pulse + self.camera_exposure_s))
